...
const CartProducts = () => {
  const { cartCount, cartDetails, removeItem, incrementItem, decrementItem } =
    useShoppingCart();
                    ...
                    <div className="w-full">
                      ...
                      <div className="flex gap-4 mt-8">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <p className="px-3 py-1 bg-slate-300 text-black rounded">
                            {entry.quantity}
                          </p>
                          <button
                            className="px-3 py-1 bg-gray-300 rounded"
      ...
      {notification && (
        <AnimatePresence>
          <motion.div
            ...
            className="fixed top-5 left-1/2 transform -translate-x-1/2 bg-red-600 text-white px-4 py-2 rounded-lg shadow-lg"
          >
            <p className="text-sm font-semibold">🗑️ Item removed from cart</p>
          </motion.div>
        </AnimatePresence>
      )}
    </div>
