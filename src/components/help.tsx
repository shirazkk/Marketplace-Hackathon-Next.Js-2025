...
import { Mail, Phone, MapPin, Clock, Package, AlertCircle, RefreshCw } from 'lucide-react';
...
const ReturnsPolicyCard = ({ title, children, className = "" }: ReturnsPolicyCardProps) => (
      ...
      <div className="container mx-auto py-12 px-4 max-w-4xl">
        ...
        <ReturnsPolicyCard title="Our Promise">
          <div className="flex items-start gap-4">
            ...
            <p className="text-gray-700">
              At <span className="font-semibold">Comforty</span>`&apos;` we want you to be completely satisfied with your purchase. 
              If for any reason you`&apos;`re not happy with your product`&apos;` we offer a hassle-free return process.
            </p>
          </div>
        </ReturnsPolicyCard>
        ...
        <ReturnsPolicyCard title="Eligibility for Returns">
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              <p className="text-gray-700">Returns accepted within {returnWindow} of delivery</p>
            </div>
            <ul className="list-none space-y-3 pl-7">
              ...
              <li className="flex items-start gap-2">
                <span className="w-2 h-2 rounded-full bg-second mt-2 flex-shrink-0" />
                <span>Customized items only returnable if damaged/defective</span>
              </li>
            </ul>
          </div>
        </ReturnsPolicyCard>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="space-y-3">
                <ol className="list-decimal pl-4 space-y-3">
                  <li>Contact our support team to request return authorization</li>
                  <li>Pack item securely in original packaging with all accessories</li>
                  <li>Ship to provided return address (shipping costs apply unless item is defective)</li>
                </ol>
              </div>
            </div>
          </div>
        ...
        <ReturnsPolicyCard title="Refund Policy">
          <div className="space-y-4 text-gray-700">
            <p>After inspection`&apos;` refunds will be processed within {refundTimeframe} to your original payment method.</p>
        ...
        {/* Contact Section */}
        <ReturnsPolicyCard title="Contact Us" className="bg-gray-800 text-white">
          <div className="grid md:grid-cols-3 gap-6">
            <div className="flex items-center gap-3">
              <Mail className="w-5 h-5 text-second" />
              <a href="mailto:support@furniro.com" className="hover:text-second">
                support@comforty.com
              </a>
            </div>
            <div className="flex items-center gap-3">
              <Phone className="w-5 h-5 text-second" />
              <span className='hover:text-second cursor-pointer'>+1 (123) 456-7890</span>
            </div>
            <div className="flex items-center gap-3">
              <MapPin className="w-5 h-5 text-second" />
              <span className='hover:text-second cursor-pointer'>123 Comforty Lane`&apos;` FC 12345</span>
            </div>
          </div>
        </ReturnsPolicyCard>
      </div>
